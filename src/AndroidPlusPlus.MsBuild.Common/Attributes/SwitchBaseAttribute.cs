...
{
  public class SwitchBaseAttribute : ToolSwitchAttribute
  {
    ...
    public override string GetName() => baseProperty.Name;

    public override object GetValue() => GetValue(parentTask, propInfo);
