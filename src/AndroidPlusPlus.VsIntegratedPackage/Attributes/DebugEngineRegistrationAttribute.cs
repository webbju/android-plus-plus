...
namespace AndroidPlusPlus.VsIntegratedPackage
{
  ...
  public sealed class DebugEngineRegistrationAttribute : RegistrationAttribute
  {
    ...
    public DebugEngineRegistrationAttribute (string idGuidString, string name, Type engineType)
      : base ()
    {
    ...
    {
      using (RegistrationAttribute.Key regKey = context.CreateKey (EngineKey))
      {
    ...
    public void Register (RegistryKey rootKey)
    {
      try
      {
        using (RegistryKey regKey = rootKey.CreateSubKey (EngineKey, RegistryKeyPermissionCheck.ReadWriteSubTree))
        {
          RegisterWithKey (regKey, regKey.GetType ());
        }
      }
    ...
    {
      rootKey.DeleteSubKeyTree (EngineKey);
    }
