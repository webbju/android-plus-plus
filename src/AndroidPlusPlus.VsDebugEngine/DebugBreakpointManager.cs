...
namespace AndroidPlusPlus.VsDebugEngine
{
  ...
  public class DebugBreakpointManager
  {
    ...
    private readonly ConcurrentBag <DebuggeeBreakpointPending> m_pendingBreakpoints;
    ...
    public DebugBreakpointManager (DebugEngine engine)
    {
      ...
      m_pendingBreakpoints = new ConcurrentBag<DebuggeeBreakpointPending> ();
    }
    ...
    public void ClearBreakpoints ()
    {
      ...
      try
      {
        while (m_pendingBreakpoints.TryTake(out DebuggeeBreakpointPending pendingBreakpoint))
        {
          int handle = pendingBreakpoint.Delete();
